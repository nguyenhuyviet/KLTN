...
{
    public partial class process_managementContext : DbContext
    {
        public process_managementContext()
        {
        }

        public process_managementContext(DbContextOptions<process_managementContext> options)
            : base(options)
        {
        }
